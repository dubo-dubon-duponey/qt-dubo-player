...
public:
    ...
    long long media_player_get_length();
    long long media_player_get_time();
    ...
    uint video_get_width(uint t);
    uint video_get_height(uint t);
    ...
    void video_set_spu(int i);
    void video_set_subtitle_file(const QString &path);
    long long video_get_spu_delay();
