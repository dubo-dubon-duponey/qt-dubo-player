...
struct DuboVLC::CheshireCatInstance
{
...
// Plain constructor
DuboVLC::DuboVLC( QObject * parent): QObject(parent), smile(new CheshireCatInstance())
{
...
// Copy constructor
DuboVLC::DuboVLC(const DuboVLC& other): QObject(), smile(new CheshireCatInstance(*(other.smile)))
{
    // XXX retain / release?
    // do nothing
}
...
// Copy assignment
DuboVLC& DuboVLC::operator=(const DuboVLC &other)
{
    *smile = *(other.smile);
    return* this;
}
...
void DuboVLC::set_user_agent(const QString &appOutput, const QString &httpOutput)
{
//    void 	libvlc_set_user_agent (libvlc_instance_t *p_instance, const char *name, const char *http)
...
const QString DuboVLC::get_compiler()
{
//    const char * 	libvlc_get_compiler (void)
//            Retrieve libvlc compiler version.
...
QStringList DuboVLC::audio_filter_list_get()
{
//    void 	libvlc_module_description_list_release (libvlc_module_description_t *p_list)
//        Release a list of module descriptions.
//    libvlc_module_description_t * 	libvlc_audio_filter_list_get (libvlc_instance_t *p_instance)
...
QStringList DuboVLC::video_filter_list_get()
{
//    void 	libvlc_module_description_list_release (libvlc_module_description_t *p_list)
//        Release a list of module descriptions.
//    libvlc_module_description_t * 	libvlc_video_filter_list_get (libvlc_instance_t *p_instance)
...
// 	Toggle mute status.
void DuboVLC::audio_toggle_mute()
{
...
// 	Set mute status.
void DuboVLC::audio_set_mute(const bool status)
{
...
void DuboVLC::audio_set_volume(const int vol)
{
...
int DuboVLC::audio_get_track_count()
{
...
QStringList DuboVLC::audio_get_track_description()
{
    QStringList l = QStringList();
...
void DuboVLC::audio_set_track(const int i)
{
...
QStringList DuboVLC::audio_output_list_get()
{
...
QStringList DuboVLC::audio_output_device_list_get(const QString & /*outd*/)
{
...
void DuboVLC::audio_output_set(const QString & outd)
{
    const char * out = outd.toLocal8Bit();
...
void DuboVLC::audio_output_device_set(const QString & /*outd*/)
{
//    const char * out = outd.toLocal8Bit();
...
void DuboVLC::toggle_fullscreen()
{
...
void DuboVLC::set_fullscreen(const bool on)
{
...
void DuboVLC::video_set_key_input(const bool on )
{
...
void DuboVLC::video_set_mouse_input(const bool on)
{
...
//int DuboVLC::libvlc_video_get_cursor_x()
//{
//    return 0;
//}

//int DuboVLC::libvlc_video_get_cursor_y()
//{
//    return 0;
//}
...
void DuboVLC::video_set_scale(const float factor)
{
...
void DuboVLC::video_set_aspect_ratio(const QString &ar)
{
    ar.toLatin1().data();
    libvlc_video_set_aspect_ratio (smile->player, "16:9");// ar.toLatin1().data());
}

//LIBVLC_API int 	libvlc_video_get_spu (libvlc_media_player_t *p_mi)
// 	Get current video subtitle.
int DuboVLC::video_get_spu()
{
...
int DuboVLC::video_get_spu_count()
{
...
QStringList DuboVLC::video_get_spu_description()
{
    QStringList l = QStringList();
...
void DuboVLC::video_set_spu_delay(const int & i)
{
...
//QStringList* DuboVLC::video_get_description()
//{
...
//QStringList* DuboVLC::video_get_chapter_description(int i)
//{
////        Get the description of available chapters for specific title.
...
void DuboVLC::video_set_crop_geometry(const QString &crop)
{
...
int DuboVLC::video_get_teletext()
{
...
void DuboVLC::video_set_teletext(const int & i)
{
...
QStringList DuboVLC::video_get_track_description()
{
    QStringList l = QStringList();
...
// 	Set video track.
void DuboVLC::video_set_track(const int i)
{
...
void DuboVLC::media_player_new(){
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_new";
    if(smile->player)
        libvlc_media_player_release(smile->player);
...
void DuboVLC::media_player_set_media(const QString & path) {
    qDebug() << " [DuboLibVLC] Cat layer: media_player_set_media " << path.toLocal8Bit();
    libvlc_media_player_set_media(smile->player, libvlc_media_new_location(smile->instance, path.toLocal8Bit()));
}
...
bool DuboVLC::vlm_add_broadcast(const QString & broadcastName, const QString & path, const QString & args) {
 ...
 * \return 0 on success, -1 on error
 */
bool DuboVLC::vlm_play_media(const QString & broadcastName) {
...
QString DuboVLC::media_player_get_media()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_get_media";
...
// 	is_playing
bool DuboVLC::media_player_is_playing()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_is_playing";
    return libvlc_media_player_is_playing(smile->player);
}

//LIBVLC_API int 	libvlc_media_player_play (libvlc_media_player_t *p_mi)
// 	Play.
void DuboVLC::media_player_play() {

    //    qDebug() << " [DuboLibVLC] Cat layer: media_player_play";
...
void DuboVLC::media_player_pause()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_pause";
    libvlc_media_player_pause(smile->player);
}

//LIBVLC_API void 	libvlc_media_player_stop (libvlc_media_player_t *p_mi)
// 	Stop (no effect if there is no media).
void DuboVLC::media_player_stop()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_stop";
...
void DuboVLC::media_player_set_time(const int & time)
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_set_time";
...
float DuboVLC::media_player_get_position()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_get_position";
...
void DuboVLC::media_player_set_position(const float & pos)
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_set_position";
...
void DuboVLC::media_player_set_chapter(const int & chap)
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_set_chapter";
...
// 	Get movie chapter.
int DuboVLC::media_player_get_chapter()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_get_chapter";
...
int DuboVLC::media_player_get_chapter_count()
{
//    qDebug() << " [DuboLibVLC] Cat layer: media_player_get_chapter_count";
